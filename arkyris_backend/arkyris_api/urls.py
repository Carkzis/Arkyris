...
from .views import EntryCreate, EntryList, EntryDetail, EntryUpdate, EntryDelete, EntryListPublic, EntryListMember

urlpatterns = [
    path('create/', EntryCreate.as_view(), name='create-entry'),
    path('', EntryList.as_view()),
    path('public/', EntryListPublic.as_view()),
    path('private/', EntryListMember.as_view()),
